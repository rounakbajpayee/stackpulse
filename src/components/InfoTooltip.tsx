    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Disclaimer */}
          {disclaimer && (
            <div className="mt-3 -mx-4 -mb-4 p-3 bg-amber-500/10 border-t border-amber-500/20 text-[10px] text-amber-300 flex items-start gap-2 rounded-b-xl leading-relaxed">
