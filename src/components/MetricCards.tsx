...
export const MetricCards: React.FC<MetricCardsProps> = ({ startups }) => {
  ...
  const dataDisclaimer = "Data is sourced from public Show HN posts, GitHub, and community submissions. Individual entries are community-curated and pending recruiter verification — some fields (category, stack, VC affiliation) may be inaccurate.";
